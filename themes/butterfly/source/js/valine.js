    ...
    return (function (e) {
                            ...
                            'GET' == e.type
                                ...
                                : 'POST' == e.type &&
                                  ...
                                  void 0 == e.contentType || null == e.contentType
                                      ? r.send(t)
                                      : (r.setRequestHeader('Content-Type', e.contentType), r.send(JSON.stringify(e.data)))),
        ...
        function (e, t, n) {
            ...
            var r = n(40),
                ...
                u = function (e, t, n, r) {
                    (!(t in e) || (l(r) && r())) &&
                        (c ? s(e, t, { configurable: !0, enumerable: !1, value: n, writable: !0 }) : (e[t] = n));
                },
                d = function (e, t) {
        ...
        function (e, t, n) {
            function r(e) {
                ...
                return (
                    (n = d.trim(n).toLowerCase()), '/' === n.slice(0, 1) && (n = n.slice(1)), '/' === n.slice(-1) && (n = n.slice(0, -1)), n
                );
            }
            function o(e) {
                return '</' === e.slice(0, 2);
...
*/
            ...
            (o.prototype.Q = function (e) {
                ...
                (o.prototype.bind = function () {
                    ...
                    var d = function (t) {
                        ...
                        r || e.$preview.hide(),
                            j != r && ((j = r), o.hasClass('actived') > -1 && j != n.html() && n.html(j), (0, c.default)(t[0]), M());
                    };
                                ...
                                (v[t] = n),
                                    n.on('input change blur propertychange', function (r) {
                                        e.config.enableQQ &&
                                            ...
                                            'comment' === t
                                                ? d(n)
                                                : (E[t] = y.default.escape(n.val().replace(/(^\s*)|(\s*$)/g, '')).substring(0, 40));
                                    });
                            })();
                    var x = function (e, t) {
                    ...
                    var C = function (t, n, r) {
                            ...
                            var l = t.get('link') ? (/^https?\:\/\//.test(t.get('link')) ? t.get('link') : 'http://' + t.get('link')) : '',
                                c = l
                                    ? '<a class="vnick" rel="nofollow" href="' + l + '" target="_blank" >' + t.get('nick') + '</a>'
                                ...
                                u = T.hide
                                    ...
                                    : '<img class="vimg" src="' + (T.cdn + (0, s.default)(t.get('mail')) + T.params) + '">',
                                d =
                                    u +
                            ...
                            o.find('a').forEach(function (e) {
                                e && !(0, y.default)(e).hasClass('at') && (0, y.default)(e).attr({ target: '_blank', rel: 'nofollow' });
                            }),
                        ...
                        P = function (t, n) {
                            t.on('click', function (r) {
                                ...
                                (0, y.default)('.vreply-wrapper[data-self-id="' + i + '"]')
                                    ...
                                    .find('.cancel-reply')
                                    .show(),
                                    (I = { at: y.default.escape(s) + ' ', rid: o, pid: i, rmail: n.get('mail') }),
                                ...
                                try {
                                    'MathJax' in window &&
                                        ...
                                        ((/^3.*/.test(window.MathJax.version) && MathJax.typeset()) ||
                                            MathJax.Hub.Queue(['Typeset', MathJax.Hub, document.querySelector('.v')])),
                        ...
                        U = function () {
                            ...
                            n.setACL(F()),
                                n
                                    ...
                                    .then(function (t) {
                                        'Anonymous' != E.nick &&
                                            y.default.store.set(h.MetaCacheKey, { nick: E.nick, link: E.link, mail: E.mail });
                                        var n = e.$el.find('.vnum');
                                        try {
                                            I.rid
                                                ? C(t, (0, y.default)('.vquote[data-self-id="' + I.rid + '"]'), !0)
                                                : (Number(n.text())
                        ...
                        (0, y.default)(document)
                            ...
                            .on('paste', function (e) {
                                var t =
                                    'clipboardData' in e
                                        ? e.clipboardData
                                        : (e.originalEvent && e.originalEvent.clipboardData) || window.clipboardData;
                                t && B(t.items, !0);
                            }),
                        ...
                        N = function t(n, r) {
                            ...
                            if (o > 0) {
                                ...
                                x(i[0], s),
                                    Q(a, function (l) {
                                        500 != l.code
                                            ? (i.val(i.val().replace(s, '![' + a.name + '](' + l.data.url + ')\r\n')),
                                              (0, c.default)(i[0]),
        ...
        function (e, t, n) {
            ...
            t.default = function (e, t) {
                ...
                i
                    ? t && t()
                    : o.default.sdkLoader('//npm.elemecdn.com/leancloud-storage@3/dist/av-min.js', 'AV', function (n) {
                          var r = 'https://',
                              o = '',
                              a = e.app_id || e.appId,
                ...
                (t.default = function (e, t) {
                    if ((e.$el && e.$loading.hide().$nodata.hide(), '[object Error]' === {}.toString.call(t))) {
                        ...
                        if (isNaN(n)) e.$el && e.$nodata.show('<pre style="text-align:left;"> ' + JSON.stringify(t) + '</pre>');
                            ...
                            101 == n || -1 == n
                                ? e.$nodata.show()
                                : e.$el && e.$nodata.show('<pre style="text-align:left;">Code ' + n + ': ' + o + '</pre>');
                        }
                ...
                i.default.setOptions({
                    ...
                    highlight: function (e, t) {
                        return 'hljs' in window
                            ? (t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value) || hljs.highlightAuto(e).value
                            : u(e);
                    },
                    gfm: !0,
                    tables: !0,
        ...
        function (e, t, n) {
            ...
            var r = function (e) {
                ...
                var d = u[t.browser];
                return (
                    d && (t.version = 'function' == typeof d ? d() : d == e ? '' : d), void 0 == t.browser && (t.browser = 'Unknow App'), t
                );
            };
            t.default = r;
        },
            ...
            (i.prototype.process = function (e) {
                ...
                return s(e, function (e, t, n, s, c) {
                    var u = o[n],
                        d = !1;
                    if (
                        (!0 === u ? (d = u) : 'function' == typeof u ? (d = u(s)) : u instanceof RegExp && (d = u.test(s)),
                        !0 !== d && (d = !1),
                        (s = l(n, s)))
                    ) {
                ...
                !(function (t) {
                    ...
                    function r(e, t) {
                        ...
                        this.options.pedantic
                            ...
                            : this.options.gfm && (this.options.breaks ? (this.rules = g.breaks) : (this.rules = g.gfm));
                    }
                    function o(e) {
                        this.options = e || h.defaults;
                    }
                    ...
                    (v._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
                        ...
                        (v.gfm.paragraph = c(v.paragraph)
                            .replace(
                                '(?!',
                                '(?!' + v.gfm.fences.source.replace('\\1', '\\2') + '|' + v.list.source.replace('\\1', '\\3') + '|'
                            )
                            .getRegex()),
                        (v.tables = p({}, v.gfm, {
                            nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
                    ...
                    (g._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
                                ...
                                if ((a = this.rules.escape.exec(e))) (e = e.substring(a[0].length)), (l += a[1]);
                                    ...
                                    if ((a = this.rules.tag.exec(e)))
                                        ...
                                        (e = e.substring(a[0].length)),
                                            ...
                                            (o = a[2]),
                                            this.options.pedantic
                                                ? ((t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(o)), t ? ((o = t[1]), (i = t[3])) : (i = ''))
                                                : (i = a[3] ? a[3].slice(1, -1) : ''),
                        ...
                        (r.prototype.mangle = function (e) {
                            ...
                            for (var t, n = '', r = e.length, o = 0; o < r; o++)
                                (t = e.charCodeAt(o)), Math.random() > 0.5 && (t = 'x' + t.toString(16)), (n += '&#' + t + ';');
                            return n;
                        }),
                        (o.prototype.code = function (e, t, n) {
                            ...
                            return t
                                ? '<pre><code class="' + this.options.langPrefix + s(t, !0) + '">' + (n ? e : s(e, !0)) + '</code></pre>\n'
                        ...
                        (a.prototype.parse = function (e) {
                            (this.inline = new r(e.links, this.options)),
                                (this.inlineText = new r(e.links, p({}, this.options, { renderer: new i() }))),
                        ...
                        (a.prototype.tok = function () {
                            switch (this.token.type) {
                                ...
                                case 'list_item_start':
                                    for (
                                        i = '', this.token.task && (i += this.renderer.checkbox(this.token.checked));
        ...
        function (e, t, n) {
            ...
            function a(e) {
                (e = i(e || {})),
                    ...
                    (this.options = e),
                    !1 === e.css ? (this.cssFilter = !1) : ((e.css = e.css || {}), (this.cssFilter = new s(e.css)));
            }
            var s = n(3).FilterCSS,
                l = n(15),
                c = n(16),
